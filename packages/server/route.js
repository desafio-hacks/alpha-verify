...
app.post("/approve-certification", (req, res) => {
  try {
    ...
    console.log(studentDatabase.has(studentAddress))
...
app.get("/certificate", (req, res) => {
  try {
    ...
    if (
      !studentDatabase.has(studentAddress) ||
      !studentDatabase.get(studentAddress).certificationApproved
    ) {
...
app.post("/add-student", (req, res) => {
  ...
  studentDatabase.set(studentAddress, {
    name,
    course,
    graduationDate,
    certificationApproved: false,
  });
  console.log("Student details: ", studentDatabase.get(studentAddress))
